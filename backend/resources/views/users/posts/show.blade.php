...
<div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 ">
	<div class="col-6 pt-4 pb-4 border bg-dark rounded-start position-relative" >
		<img src="{{ App\Models\Post::showImage($post->image) }}" class="img-fluid position-relative top-50 start-50 translate-middle"/>
	</div>

	<div class="col-6 p-2 d-flex flex-column position-static">
		<p>
			<img src="{{ App\Models\User::showAvatar($post->user->avatar) }}" class="rounded border border-1 rounded-circle" style="height: 2.4rem; width: 2.4rem; "/> 
